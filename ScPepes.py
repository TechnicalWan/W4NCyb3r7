#!/usr/bin/python
#######################
#  http://YouTube.com/c/MisQueenGamerS  #
#######################
mess = """======================================================
                   Deface Script Creator        
__        ___  _   _   _    ____      _    _____     _____
\ \      / / || | | \ | |  / ___|   _| |__|___ / _ _|___  |
 \ \ /\ / /| || |_|  \| | | |  | | | | '_ \ |_ \| '__| / /
  \ V  V / |__   _| |\  | | |__| |_| | |_) |__) | |   / /
   \_/\_/     |_| |_| \_|  \____\__, |_.__/____/|_|  /_/
                                |___/
======================================================"""
print mess
print "Created by Technical Wan/W4N Cyb3r7"
...
youtubeid = raw_input("Kode Musik Youtube link : ")
...
print "Kontak : Channel Yt Technical Wan"
